...
export default function OnboardingPage() {
  ...
  async function handleFinish() {
    ...
    try {
      ...
      // Crear store_config con los atributos del rubro
      ...
      <div className="max-w-2xl mx-auto px-6 py-10">
        ...
        {step === 1 && (
          <div className="space-y-6">
            ...
            <button
              onClick={() => {
                if (!storeName.trim()) { setError('Ingresá el nombre de tu tienda'); return }
                setError(null)
                setStep(2)
              }}
        ...
        {step === 2 && (
          <div className="space-y-6">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-400 mt-0.5">
                        {template.variant_attributes.map(a => a.label).join(' · ')}
                      </p>
                    </div>
                    {selected && (
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={() => {
                  if (!selectedTemplate) { setError('Elegí un rubro'); return }
                  setError(null)
                  setStep(3)
                }}
        ...
        {/* STEP 3: Confirmar y personalizar atributos */}
        {step === 3 && (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-zinc-500 mt-1">
                Estos son los campos que vas a completar al cargar cada producto. Podés agregar o quitar.
              </p>
            </div>
